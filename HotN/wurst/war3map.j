...
function main takes nothing returns nothing
    ...
    call InitGlobals()
    call InitTrig_Unbezeichneter_Ausl__ser_003() // INLINED!!
    call ConditionalTriggerExecute(gg_trg_Unbezeichneter_Ausl__ser_003) // INLINED!!
